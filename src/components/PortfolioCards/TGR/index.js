...
const TGR = () => {
  return (
    ...
    <CardBody className='cardContainer'>
      ...
      <CardSubtitle tag="h6" className="mb-2 text-muted">Web-based Interactive Story</CardSubtitle>
      <CardText>The Gate Room is designed to host several interactive stories to delight and entertain.</CardText>
